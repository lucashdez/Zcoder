...
fn read_format_table_f4(offset: u32, buf: []const u8) CmapFormat4 {
    ...
    table.reservedPad = fu.read_u16m(&pos, buf);
    ...
    for (0..mem_reserve) |i| {
        table.endCode[i] = fu.read_u16m(&end_pos_start, buf);
