...
pub const struct_wl_object = extern struct {
    interface: [*c]const struct_wl_interface = @import("std").mem.zeroes([*c]const struct_wl_interface),
    implementation: ?*const anyopaque = @import("std").mem.zeroes(?*const anyopaque),
...
pub const wl_log_func_t = ?*const fn ([*c]const u8, [*c]struct___va_list_tag_3) callconv(.C) void;
pub const WL_ITERATOR_STOP: c_int = 0;
pub const WL_ITERATOR_CONTINUE: c_int = 1;
pub const enum_wl_iterator_result = c_uint;
pub const WL_EVENT_READABLE: c_int = 1;
pub const WL_EVENT_WRITABLE: c_int = 2;
pub const WL_EVENT_HANGUP: c_int = 4;
pub const WL_EVENT_ERROR: c_int = 8;
const enum_unnamed_4 = c_uint;
pub const wl_event_loop_fd_func_t = ?*const fn (c_int, u32, ?*anyopaque) callconv(.C) c_int;
pub const wl_event_loop_timer_func_t = ?*const fn (?*anyopaque) callconv(.C) c_int;
pub const wl_event_loop_signal_func_t = ?*const fn (c_int, ?*anyopaque) callconv(.C) c_int;
pub const wl_event_loop_idle_func_t = ?*const fn (?*anyopaque) callconv(.C) void;
pub const struct_wl_event_loop = opaque {};
pub extern fn wl_event_loop_create() ?*struct_wl_event_loop;
pub extern fn wl_event_loop_destroy(loop: ?*struct_wl_event_loop) void;
pub const struct_wl_event_source = opaque {};
pub extern fn wl_event_loop_add_fd(loop: ?*struct_wl_event_loop, fd: c_int, mask: u32, func: wl_event_loop_fd_func_t, data: ?*anyopaque) ?*struct_wl_event_source;
pub extern fn wl_event_source_fd_update(source: ?*struct_wl_event_source, mask: u32) c_int;
pub extern fn wl_event_loop_add_timer(loop: ?*struct_wl_event_loop, func: wl_event_loop_timer_func_t, data: ?*anyopaque) ?*struct_wl_event_source;
pub extern fn wl_event_loop_add_signal(loop: ?*struct_wl_event_loop, signal_number: c_int, func: wl_event_loop_signal_func_t, data: ?*anyopaque) ?*struct_wl_event_source;
pub extern fn wl_event_source_timer_update(source: ?*struct_wl_event_source, ms_delay: c_int) c_int;
pub extern fn wl_event_source_remove(source: ?*struct_wl_event_source) c_int;
pub extern fn wl_event_source_check(source: ?*struct_wl_event_source) void;
pub extern fn wl_event_loop_dispatch(loop: ?*struct_wl_event_loop, timeout: c_int) c_int;
pub extern fn wl_event_loop_dispatch_idle(loop: ?*struct_wl_event_loop) void;
pub extern fn wl_event_loop_add_idle(loop: ?*struct_wl_event_loop, func: wl_event_loop_idle_func_t, data: ?*anyopaque) ?*struct_wl_event_source;
pub extern fn wl_event_loop_get_fd(loop: ?*struct_wl_event_loop) c_int;
pub const wl_notify_func_t = ?*const fn ([*c]struct_wl_listener, ?*anyopaque) callconv(.C) void;
pub const struct_wl_listener = extern struct {
    link: struct_wl_list = @import("std").mem.zeroes(struct_wl_list),
    notify: wl_notify_func_t = @import("std").mem.zeroes(wl_notify_func_t),
};
pub extern fn wl_event_loop_add_destroy_listener(loop: ?*struct_wl_event_loop, listener: [*c]struct_wl_listener) void;
pub extern fn wl_event_loop_get_destroy_listener(loop: ?*struct_wl_event_loop, notify: wl_notify_func_t) [*c]struct_wl_listener;
pub const struct_wl_display = opaque {};
pub extern fn wl_display_create() ?*struct_wl_display;
pub extern fn wl_display_destroy(display: ?*struct_wl_display) void;
pub extern fn wl_display_get_event_loop(display: ?*struct_wl_display) ?*struct_wl_event_loop;
pub extern fn wl_display_add_socket(display: ?*struct_wl_display, name: [*c]const u8) c_int;
pub extern fn wl_display_add_socket_auto(display: ?*struct_wl_display) [*c]const u8;
pub extern fn wl_display_add_socket_fd(display: ?*struct_wl_display, sock_fd: c_int) c_int;
pub extern fn wl_display_terminate(display: ?*struct_wl_display) void;
pub extern fn wl_display_run(display: ?*struct_wl_display) void;
pub extern fn wl_display_flush_clients(display: ?*struct_wl_display) void;
pub extern fn wl_display_destroy_clients(display: ?*struct_wl_display) void;
pub extern fn wl_display_set_default_max_buffer_size(display: ?*struct_wl_display, max_buffer_size: usize) void;
pub const struct_wl_client = opaque {};
pub const wl_global_bind_func_t = ?*const fn (?*struct_wl_client, ?*anyopaque, u32, u32) callconv(.C) void;
pub extern fn wl_display_get_serial(display: ?*struct_wl_display) u32;
pub extern fn wl_display_next_serial(display: ?*struct_wl_display) u32;
pub extern fn wl_display_add_destroy_listener(display: ?*struct_wl_display, listener: [*c]struct_wl_listener) void;
pub extern fn wl_display_add_client_created_listener(display: ?*struct_wl_display, listener: [*c]struct_wl_listener) void;
pub extern fn wl_display_get_destroy_listener(display: ?*struct_wl_display, notify: wl_notify_func_t) [*c]struct_wl_listener;
pub const struct_wl_global = opaque {};
pub extern fn wl_global_create(display: ?*struct_wl_display, interface: [*c]const struct_wl_interface, version: c_int, data: ?*anyopaque, bind: wl_global_bind_func_t) ?*struct_wl_global;
pub extern fn wl_global_remove(global: ?*struct_wl_global) void;
pub extern fn wl_global_destroy(global: ?*struct_wl_global) void;
pub const wl_display_global_filter_func_t = ?*const fn (?*const struct_wl_client, ?*const struct_wl_global, ?*anyopaque) callconv(.C) bool;
pub extern fn wl_display_set_global_filter(display: ?*struct_wl_display, filter: wl_display_global_filter_func_t, data: ?*anyopaque) void;
pub extern fn wl_global_get_interface(global: ?*const struct_wl_global) [*c]const struct_wl_interface;
pub extern fn wl_global_get_name(global: ?*const struct_wl_global, client: ?*const struct_wl_client) u32;
pub extern fn wl_global_get_version(global: ?*const struct_wl_global) u32;
pub extern fn wl_global_get_display(global: ?*const struct_wl_global) ?*struct_wl_display;
pub extern fn wl_global_get_user_data(global: ?*const struct_wl_global) ?*anyopaque;
pub extern fn wl_global_set_user_data(global: ?*struct_wl_global, data: ?*anyopaque) void;
pub extern fn wl_client_create(display: ?*struct_wl_display, fd: c_int) ?*struct_wl_client;
pub extern fn wl_display_get_client_list(display: ?*struct_wl_display) [*c]struct_wl_list;
pub extern fn wl_client_get_link(client: ?*struct_wl_client) [*c]struct_wl_list;
pub extern fn wl_client_from_link(link: [*c]struct_wl_list) ?*struct_wl_client;
pub extern fn wl_client_destroy(client: ?*struct_wl_client) void;
pub extern fn wl_client_flush(client: ?*struct_wl_client) void;
pub extern fn wl_client_get_credentials(client: ?*struct_wl_client, pid: [*c]pid_t, uid: [*c]uid_t, gid: [*c]gid_t) void;
pub extern fn wl_client_get_fd(client: ?*struct_wl_client) c_int;
pub extern fn wl_client_add_destroy_listener(client: ?*struct_wl_client, listener: [*c]struct_wl_listener) void;
pub extern fn wl_client_get_destroy_listener(client: ?*struct_wl_client, notify: wl_notify_func_t) [*c]struct_wl_listener;
pub extern fn wl_client_add_destroy_late_listener(client: ?*struct_wl_client, listener: [*c]struct_wl_listener) void;
pub extern fn wl_client_get_destroy_late_listener(client: ?*struct_wl_client, notify: wl_notify_func_t) [*c]struct_wl_listener;
pub const wl_resource_destroy_func_t = ?*const fn ([*c]struct_wl_resource) callconv(.C) void;
pub const struct_wl_signal = extern struct {
    listener_list: struct_wl_list = @import("std").mem.zeroes(struct_wl_list),
};
pub const struct_wl_resource = extern struct {
    object: struct_wl_object = @import("std").mem.zeroes(struct_wl_object),
    destroy: wl_resource_destroy_func_t = @import("std").mem.zeroes(wl_resource_destroy_func_t),
    link: struct_wl_list = @import("std").mem.zeroes(struct_wl_list),
    destroy_signal: struct_wl_signal = @import("std").mem.zeroes(struct_wl_signal),
    client: ?*struct_wl_client = @import("std").mem.zeroes(?*struct_wl_client),
    data: ?*anyopaque = @import("std").mem.zeroes(?*anyopaque),
};
pub extern fn wl_client_get_object(client: ?*struct_wl_client, id: u32) [*c]struct_wl_resource;
pub extern fn wl_client_post_no_memory(client: ?*struct_wl_client) void;
pub extern fn wl_client_post_implementation_error(client: ?*struct_wl_client, msg: [*c]const u8, ...) void;
pub extern fn wl_client_add_resource_created_listener(client: ?*struct_wl_client, listener: [*c]struct_wl_listener) void;
pub const wl_client_for_each_resource_iterator_func_t = ?*const fn ([*c]struct_wl_resource, ?*anyopaque) callconv(.C) enum_wl_iterator_result;
pub extern fn wl_client_for_each_resource(client: ?*struct_wl_client, iterator: wl_client_for_each_resource_iterator_func_t, user_data: ?*anyopaque) void;
pub const wl_user_data_destroy_func_t = ?*const fn (?*anyopaque) callconv(.C) void;
pub extern fn wl_client_set_user_data(client: ?*struct_wl_client, data: ?*anyopaque, dtor: wl_user_data_destroy_func_t) void;
pub extern fn wl_client_get_user_data(client: ?*struct_wl_client) ?*anyopaque;
pub extern fn wl_client_set_max_buffer_size(client: ?*struct_wl_client, max_buffer_size: usize) void;
pub fn wl_signal_init(arg_signal: [*c]struct_wl_signal) callconv(.C) void {
    var signal = arg_signal;
    _ = &signal;
    wl_list_init(&signal.*.listener_list);
}
pub fn wl_signal_add(arg_signal: [*c]struct_wl_signal, arg_listener: [*c]struct_wl_listener) callconv(.C) void {
    var signal = arg_signal;
    _ = &signal;
...
pub fn wl_signal_get(arg_signal: [*c]struct_wl_signal, arg_notify: wl_notify_func_t) callconv(.C) [*c]struct_wl_listener {
    var signal = arg_signal;
    _ = &signal;
    var notify = arg_notify;
    _ = &notify;
    var l: [*c]struct_wl_listener = undefined;
    _ = &l;
    {
        l = @as(@TypeOf(l), @ptrCast(@alignCast(@as([*c]u8, @ptrCast(@alignCast((&signal.*.listener_list).*.next))) - @offsetOf(struct_wl_listener, "link"))));
        while ((&l.*.link) != (&signal.*.listener_list)) : (l = @as(@TypeOf(l), @ptrCast(@alignCast(@as([*c]u8, @ptrCast(@alignCast(l.*.link.next))) - @offsetOf(struct_wl_listener, "link"))))) if (l.*.notify == notify) return l;
    }
    return null;
}
pub fn wl_signal_emit(arg_signal: [*c]struct_wl_signal, arg_data: ?*anyopaque) callconv(.C) void {
    var signal = arg_signal;
    _ = &signal;
    var data = arg_data;
    _ = &data;
    var l: [*c]struct_wl_listener = undefined;
    _ = &l;
    var next: [*c]struct_wl_listener = undefined;
    _ = &next;
    {
        _ = blk: {
            l = @as(@TypeOf(l), @ptrCast(@alignCast(@as([*c]u8, @ptrCast(@alignCast((&signal.*.listener_list).*.next))) - @offsetOf(struct_wl_listener, "link"))));
            break :blk blk_1: {
                const tmp = @as(@TypeOf(next), @ptrCast(@alignCast(@as([*c]u8, @ptrCast(@alignCast(l.*.link.next))) - @offsetOf(struct_wl_listener, "link"))));
                next = tmp;
                break :blk_1 tmp;
            };
        };
        while ((&l.*.link) != (&signal.*.listener_list)) : (_ = blk: {
            l = next;
            break :blk blk_1: {
                const tmp = @as(@TypeOf(next), @ptrCast(@alignCast(@as([*c]u8, @ptrCast(@alignCast(l.*.link.next))) - @offsetOf(struct_wl_listener, "link"))));
                next = tmp;
...
pub extern fn wl_signal_emit_mutable(signal: [*c]struct_wl_signal, data: ?*anyopaque) void;
pub extern fn wl_resource_post_event(resource: [*c]struct_wl_resource, opcode: u32, ...) void;
pub extern fn wl_resource_post_event_array(resource: [*c]struct_wl_resource, opcode: u32, args: [*c]union_wl_argument) void;
pub extern fn wl_resource_queue_event(resource: [*c]struct_wl_resource, opcode: u32, ...) void;
pub extern fn wl_resource_queue_event_array(resource: [*c]struct_wl_resource, opcode: u32, args: [*c]union_wl_argument) void;
pub extern fn wl_resource_post_error(resource: [*c]struct_wl_resource, code: u32, msg: [*c]const u8, ...) void;
pub extern fn wl_resource_post_no_memory(resource: [*c]struct_wl_resource) void;
pub extern fn wl_client_get_display(client: ?*struct_wl_client) ?*struct_wl_display;
pub extern fn wl_resource_create(client: ?*struct_wl_client, interface: [*c]const struct_wl_interface, version: c_int, id: u32) [*c]struct_wl_resource;
pub extern fn wl_resource_set_implementation(resource: [*c]struct_wl_resource, implementation: ?*const anyopaque, data: ?*anyopaque, destroy: wl_resource_destroy_func_t) void;
pub extern fn wl_resource_set_dispatcher(resource: [*c]struct_wl_resource, dispatcher: wl_dispatcher_func_t, implementation: ?*const anyopaque, data: ?*anyopaque, destroy: wl_resource_destroy_func_t) void;
pub extern fn wl_resource_destroy(resource: [*c]struct_wl_resource) void;
pub extern fn wl_resource_get_id(resource: [*c]struct_wl_resource) u32;
pub extern fn wl_resource_get_link(resource: [*c]struct_wl_resource) [*c]struct_wl_list;
pub extern fn wl_resource_from_link(resource: [*c]struct_wl_list) [*c]struct_wl_resource;
pub extern fn wl_resource_find_for_client(list: [*c]struct_wl_list, client: ?*struct_wl_client) [*c]struct_wl_resource;
pub extern fn wl_resource_get_client(resource: [*c]struct_wl_resource) ?*struct_wl_client;
pub extern fn wl_resource_set_user_data(resource: [*c]struct_wl_resource, data: ?*anyopaque) void;
pub extern fn wl_resource_get_user_data(resource: [*c]struct_wl_resource) ?*anyopaque;
pub extern fn wl_resource_get_version(resource: [*c]struct_wl_resource) c_int;
pub extern fn wl_resource_set_destructor(resource: [*c]struct_wl_resource, destroy: wl_resource_destroy_func_t) void;
pub extern fn wl_resource_instance_of(resource: [*c]struct_wl_resource, interface: [*c]const struct_wl_interface, implementation: ?*const anyopaque) c_int;
pub extern fn wl_resource_get_class(resource: [*c]struct_wl_resource) [*c]const u8;
pub extern fn wl_resource_add_destroy_listener(resource: [*c]struct_wl_resource, listener: [*c]struct_wl_listener) void;
pub extern fn wl_resource_get_destroy_listener(resource: [*c]struct_wl_resource, notify: wl_notify_func_t) [*c]struct_wl_listener;
pub const struct_wl_shm_buffer = opaque {};
pub extern fn wl_shm_buffer_get(resource: [*c]struct_wl_resource) ?*struct_wl_shm_buffer;
...
pub extern fn wl_shm_buffer_get_data(buffer: ?*struct_wl_shm_buffer) ?*anyopaque;
...
pub extern fn wl_display_init_shm(display: ?*struct_wl_display) c_int;
pub extern fn wl_display_add_shm_format(display: ?*struct_wl_display, format: u32) [*c]u32;
pub extern fn wl_shm_buffer_create(client: ?*struct_wl_client, id: u32, width: i32, height: i32, stride: i32, format: u32) ?*struct_wl_shm_buffer;
pub extern fn wl_log_set_handler_server(handler: wl_log_func_t) void;
pub const WL_PROTOCOL_LOGGER_REQUEST: c_int = 0;
pub const WL_PROTOCOL_LOGGER_EVENT: c_int = 1;
pub const enum_wl_protocol_logger_type = c_uint;
pub const struct_wl_protocol_logger_message = extern struct {
    resource: [*c]struct_wl_resource = @import("std").mem.zeroes([*c]struct_wl_resource),
    message_opcode: c_int = @import("std").mem.zeroes(c_int),
    message: [*c]const struct_wl_message = @import("std").mem.zeroes([*c]const struct_wl_message),
    arguments_count: c_int = @import("std").mem.zeroes(c_int),
    arguments: [*c]const union_wl_argument = @import("std").mem.zeroes([*c]const union_wl_argument),
};
pub const wl_protocol_logger_func_t = ?*const fn (?*anyopaque, enum_wl_protocol_logger_type, [*c]const struct_wl_protocol_logger_message) callconv(.C) void;
pub const struct_wl_protocol_logger = opaque {};
pub extern fn wl_display_add_protocol_logger(display: ?*struct_wl_display, wl_protocol_logger_func_t, user_data: ?*anyopaque) ?*struct_wl_protocol_logger;
pub extern fn wl_protocol_logger_destroy(logger: ?*struct_wl_protocol_logger) void;
pub extern fn wl_client_add_resource(client: ?*struct_wl_client, resource: [*c]struct_wl_resource) u32;
pub extern fn wl_client_add_object(client: ?*struct_wl_client, interface: [*c]const struct_wl_interface, implementation: ?*const anyopaque, id: u32, data: ?*anyopaque) [*c]struct_wl_resource;
pub extern fn wl_client_new_object(client: ?*struct_wl_client, interface: [*c]const struct_wl_interface, implementation: ?*const anyopaque, data: ?*anyopaque) [*c]struct_wl_resource;
pub extern fn wl_display_add_global(display: ?*struct_wl_display, interface: [*c]const struct_wl_interface, data: ?*anyopaque, bind: wl_global_bind_func_t) ?*struct_wl_global;
pub extern fn wl_display_remove_global(display: ?*struct_wl_display, global: ?*struct_wl_global) void;
...
pub fn wl_display_error_is_valid(arg_value: u32, arg_version: u32) callconv(.C) bool {
    var value = arg_value;
    _ = &value;
    ...
    while (true) {
        switch (value) {
            @as(u32, @bitCast(@as(c_int, 0))) => return version >= @as(u32, @bitCast(@as(c_int, 1))),
            @as(u32, @bitCast(@as(c_int, 1))) => return version >= @as(u32, @bitCast(@as(c_int, 1))),
            @as(u32, @bitCast(@as(c_int, 2))) => return version >= @as(u32, @bitCast(@as(c_int, 1))),
            @as(u32, @bitCast(@as(c_int, 3))) => return version >= @as(u32, @bitCast(@as(c_int, 1))),
...
pub const struct_wl_display_interface = extern struct {
    sync: ?*const fn (?*struct_wl_client, [*c]struct_wl_resource, u32) callconv(.C) void = @import("std").mem.zeroes(?*const fn (?*struct_wl_client, [*c]struct_wl_resource, u32) callconv(.C) void),
    get_registry: ?*const fn (?*struct_wl_client, [*c]struct_wl_resource, u32) callconv(.C) void = @import("std").mem.zeroes(?*const fn (?*struct_wl_client, [*c]struct_wl_resource, u32) callconv(.C) void),
};
pub const struct_wl_registry_interface = extern struct {
    bind: ?*const fn (?*struct_wl_client, [*c]struct_wl_resource, u32, [*c]const u8, u32, u32) callconv(.C) void = @import("std").mem.zeroes(?*const fn (?*struct_wl_client, [*c]struct_wl_resource, u32, [*c]const u8, u32, u32) callconv(.C) void),
};
pub fn wl_registry_send_global(arg_resource_: [*c]struct_wl_resource, arg_name: u32, arg_interface: [*c]const u8, arg_version: u32) callconv(.C) void {
    ...
    var version = arg_version;
    _ = &version;
    wl_resource_post_event(resource_, @as(u32, @bitCast(@as(c_int, 0))), name, interface, version);
}
pub fn wl_registry_send_global_remove(arg_resource_: [*c]struct_wl_resource, arg_name: u32) callconv(.C) void {
    var resource_ = arg_resource_;
    _ = &resource_;
    var name = arg_name;
    _ = &name;
    wl_resource_post_event(resource_, @as(u32, @bitCast(@as(c_int, 1))), name);
}
pub fn wl_callback_send_done(arg_resource_: [*c]struct_wl_resource, arg_callback_data: u32) callconv(.C) void {
    var resource_ = arg_resource_;
    _ = &resource_;
    var callback_data = arg_callback_data;
    _ = &callback_data;
    wl_resource_post_event(resource_, @as(u32, @bitCast(@as(c_int, 0))), callback_data);
}
pub const struct_wl_compositor_interface = extern struct {
    create_surface: ?*const fn (?*struct_wl_client, [*c]struct_wl_resource, u32) callconv(.C) void = @import("std").mem.zeroes(?*const fn (?*struct_wl_client, [*c]struct_wl_resource, u32) callconv(.C) void),
    create_region: ?*const fn (?*struct_wl_client, [*c]struct_wl_resource, u32) callconv(.C) void = @import("std").mem.zeroes(?*const fn (?*struct_wl_client, [*c]struct_wl_resource, u32) callconv(.C) void),
};
pub const struct_wl_shm_pool_interface = extern struct {
    create_buffer: ?*const fn (?*struct_wl_client, [*c]struct_wl_resource, u32, i32, i32, i32, i32, u32) callconv(.C) void = @import("std").mem.zeroes(?*const fn (?*struct_wl_client, [*c]struct_wl_resource, u32, i32, i32, i32, i32, u32) callconv(.C) void),
    destroy: ?*const fn (?*struct_wl_client, [*c]struct_wl_resource) callconv(.C) void = @import("std").mem.zeroes(?*const fn (?*struct_wl_client, [*c]struct_wl_resource) callconv(.C) void),
    resize: ?*const fn (?*struct_wl_client, [*c]struct_wl_resource, i32) callconv(.C) void = @import("std").mem.zeroes(?*const fn (?*struct_wl_client, [*c]struct_wl_resource, i32) callconv(.C) void),
};
...
pub fn wl_shm_error_is_valid(arg_value: u32, arg_version: u32) callconv(.C) bool {
    var value = arg_value;
    _ = &value;
    var version = arg_version;
    _ = &version;
...
pub fn wl_shm_format_is_valid(arg_value: u32, arg_version: u32) callconv(.C) bool {
    var value = arg_value;
    _ = &value;
    var version = arg_version;
    _ = &version;
    while (true) {
        switch (value) {
            @as(u32, @bitCast(@as(c_int, 0))) => return version >= @as(u32, @bitCast(@as(c_int, 1))),
            @as(u32, @bitCast(@as(c_int, 1))) => return version >= @as(u32, @bitCast(@as(c_int, 1))),
            @as(u32, @bitCast(@as(c_int, 538982467))) => return version >= @as(u32, @bitCast(@as(c_int, 1))),
            @as(u32, @bitCast(@as(c_int, 943867730))) => return version >= @as(u32, @bitCast(@as(c_int, 1))),
            @as(u32, @bitCast(@as(c_int, 944916290))) => return version >= @as(u32, @bitCast(@as(c_int, 1))),
            @as(u32, @bitCast(@as(c_int, 842093144))) => return version >= @as(u32, @bitCast(@as(c_int, 1))),
            @as(u32, @bitCast(@as(c_int, 842089048))) => return version >= @as(u32, @bitCast(@as(c_int, 1))),
            @as(u32, @bitCast(@as(c_int, 842094674))) => return version >= @as(u32, @bitCast(@as(c_int, 1))),
            @as(u32, @bitCast(@as(c_int, 842094658))) => return version >= @as(u32, @bitCast(@as(c_int, 1))),
            @as(u32, @bitCast(@as(c_int, 842093121))) => return version >= @as(u32, @bitCast(@as(c_int, 1))),
            @as(u32, @bitCast(@as(c_int, 842089025))) => return version >= @as(u32, @bitCast(@as(c_int, 1))),
            @as(u32, @bitCast(@as(c_int, 842088786))) => return version >= @as(u32, @bitCast(@as(c_int, 1))),
            @as(u32, @bitCast(@as(c_int, 842088770))) => return version >= @as(u32, @bitCast(@as(c_int, 1))),
            @as(u32, @bitCast(@as(c_int, 892424792))) => return version >= @as(u32, @bitCast(@as(c_int, 1))),
            @as(u32, @bitCast(@as(c_int, 892420696))) => return version >= @as(u32, @bitCast(@as(c_int, 1))),
            @as(u32, @bitCast(@as(c_int, 892426322))) => return version >= @as(u32, @bitCast(@as(c_int, 1))),
            @as(u32, @bitCast(@as(c_int, 892426306))) => return version >= @as(u32, @bitCast(@as(c_int, 1))),
            @as(u32, @bitCast(@as(c_int, 892424769))) => return version >= @as(u32, @bitCast(@as(c_int, 1))),
            @as(u32, @bitCast(@as(c_int, 892420673))) => return version >= @as(u32, @bitCast(@as(c_int, 1))),
            @as(u32, @bitCast(@as(c_int, 892420434))) => return version >= @as(u32, @bitCast(@as(c_int, 1))),
            @as(u32, @bitCast(@as(c_int, 892420418))) => return version >= @as(u32, @bitCast(@as(c_int, 1))),
            @as(u32, @bitCast(@as(c_int, 909199186))) => return version >= @as(u32, @bitCast(@as(c_int, 1))),
            @as(u32, @bitCast(@as(c_int, 909199170))) => return version >= @as(u32, @bitCast(@as(c_int, 1))),
            @as(u32, @bitCast(@as(c_int, 875710290))) => return version >= @as(u32, @bitCast(@as(c_int, 1))),
            @as(u32, @bitCast(@as(c_int, 875710274))) => return version >= @as(u32, @bitCast(@as(c_int, 1))),
            @as(u32, @bitCast(@as(c_int, 875709016))) => return version >= @as(u32, @bitCast(@as(c_int, 1))),
            @as(u32, @bitCast(@as(c_int, 875714642))) => return version >= @as(u32, @bitCast(@as(c_int, 1))),
            @as(u32, @bitCast(@as(c_int, 875714626))) => return version >= @as(u32, @bitCast(@as(c_int, 1))),
            @as(u32, @bitCast(@as(c_int, 875708993))) => return version >= @as(u32, @bitCast(@as(c_int, 1))),
            @as(u32, @bitCast(@as(c_int, 875708754))) => return version >= @as(u32, @bitCast(@as(c_int, 1))),
            @as(u32, @bitCast(@as(c_int, 875708738))) => return version >= @as(u32, @bitCast(@as(c_int, 1))),
            @as(u32, @bitCast(@as(c_int, 808669784))) => return version >= @as(u32, @bitCast(@as(c_int, 1))),
            @as(u32, @bitCast(@as(c_int, 808665688))) => return version >= @as(u32, @bitCast(@as(c_int, 1))),
            @as(u32, @bitCast(@as(c_int, 808671314))) => return version >= @as(u32, @bitCast(@as(c_int, 1))),
            @as(u32, @bitCast(@as(c_int, 808671298))) => return version >= @as(u32, @bitCast(@as(c_int, 1))),
            @as(u32, @bitCast(@as(c_int, 808669761))) => return version >= @as(u32, @bitCast(@as(c_int, 1))),
            @as(u32, @bitCast(@as(c_int, 808665665))) => return version >= @as(u32, @bitCast(@as(c_int, 1))),
            @as(u32, @bitCast(@as(c_int, 808665426))) => return version >= @as(u32, @bitCast(@as(c_int, 1))),
            @as(u32, @bitCast(@as(c_int, 808665410))) => return version >= @as(u32, @bitCast(@as(c_int, 1))),
            @as(u32, @bitCast(@as(c_int, 1448695129))) => return version >= @as(u32, @bitCast(@as(c_int, 1))),
            @as(u32, @bitCast(@as(c_int, 1431918169))) => return version >= @as(u32, @bitCast(@as(c_int, 1))),
            @as(u32, @bitCast(@as(c_int, 1498831189))) => return version >= @as(u32, @bitCast(@as(c_int, 1))),
            @as(u32, @bitCast(@as(c_int, 1498765654))) => return version >= @as(u32, @bitCast(@as(c_int, 1))),
            @as(u32, @bitCast(@as(c_int, 1448433985))) => return version >= @as(u32, @bitCast(@as(c_int, 1))),
            @as(u32, @bitCast(@as(c_int, 842094158))) => return version >= @as(u32, @bitCast(@as(c_int, 1))),
            @as(u32, @bitCast(@as(c_int, 825382478))) => return version >= @as(u32, @bitCast(@as(c_int, 1))),
            @as(u32, @bitCast(@as(c_int, 909203022))) => return version >= @as(u32, @bitCast(@as(c_int, 1))),
            @as(u32, @bitCast(@as(c_int, 825644622))) => return version >= @as(u32, @bitCast(@as(c_int, 1))),
            @as(u32, @bitCast(@as(c_int, 961959257))) => return version >= @as(u32, @bitCast(@as(c_int, 1))),
            @as(u32, @bitCast(@as(c_int, 961893977))) => return version >= @as(u32, @bitCast(@as(c_int, 1))),
            @as(u32, @bitCast(@as(c_int, 825316697))) => return version >= @as(u32, @bitCast(@as(c_int, 1))),
            @as(u32, @bitCast(@as(c_int, 825316953))) => return version >= @as(u32, @bitCast(@as(c_int, 1))),
            @as(u32, @bitCast(@as(c_int, 842093913))) => return version >= @as(u32, @bitCast(@as(c_int, 1))),
            @as(u32, @bitCast(@as(c_int, 842094169))) => return version >= @as(u32, @bitCast(@as(c_int, 1))),
            @as(u32, @bitCast(@as(c_int, 909202777))) => return version >= @as(u32, @bitCast(@as(c_int, 1))),
            @as(u32, @bitCast(@as(c_int, 909203033))) => return version >= @as(u32, @bitCast(@as(c_int, 1))),
            @as(u32, @bitCast(@as(c_int, 875713881))) => return version >= @as(u32, @bitCast(@as(c_int, 1))),
            @as(u32, @bitCast(@as(c_int, 875714137))) => return version >= @as(u32, @bitCast(@as(c_int, 1))),
            @as(u32, @bitCast(@as(c_int, 538982482))) => return version >= @as(u32, @bitCast(@as(c_int, 1))),
            @as(u32, @bitCast(@as(c_int, 540422482))) => return version >= @as(u32, @bitCast(@as(c_int, 1))),
            @as(u32, @bitCast(@as(c_int, 943212370))) => return version >= @as(u32, @bitCast(@as(c_int, 1))),
            @as(u32, @bitCast(@as(c_int, 943215175))) => return version >= @as(u32, @bitCast(@as(c_int, 1))),
            @as(u32, @bitCast(@as(c_int, 842221394))) => return version >= @as(u32, @bitCast(@as(c_int, 1))),
            @as(u32, @bitCast(@as(c_int, 842224199))) => return version >= @as(u32, @bitCast(@as(c_int, 1))),
            @as(u32, @bitCast(@as(c_int, 1211388504))) => return version >= @as(u32, @bitCast(@as(c_int, 1))),
            @as(u32, @bitCast(@as(c_int, 1211384408))) => return version >= @as(u32, @bitCast(@as(c_int, 1))),
            @as(u32, @bitCast(@as(c_int, 1211388481))) => return version >= @as(u32, @bitCast(@as(c_int, 1))),
            @as(u32, @bitCast(@as(c_int, 1211384385))) => return version >= @as(u32, @bitCast(@as(c_int, 1))),
            @as(u32, @bitCast(@as(c_int, 1448434008))) => return version >= @as(u32, @bitCast(@as(c_int, 1))),
            @as(u32, @bitCast(@as(c_int, 875713878))) => return version >= @as(u32, @bitCast(@as(c_int, 1))),
            @as(u32, @bitCast(@as(c_int, 808670550))) => return version >= @as(u32, @bitCast(@as(c_int, 1))),
            @as(u32, @bitCast(@as(c_int, 808530521))) => return version >= @as(u32, @bitCast(@as(c_int, 1))),
            @as(u32, @bitCast(@as(c_int, 842084953))) => return version >= @as(u32, @bitCast(@as(c_int, 1))),
            @as(u32, @bitCast(@as(c_int, 909193817))) => return version >= @as(u32, @bitCast(@as(c_int, 1))),
            @as(u32, @bitCast(@as(c_int, 808531033))) => return version >= @as(u32, @bitCast(@as(c_int, 1))),
            @as(u32, @bitCast(@as(c_int, 842085465))) => return version >= @as(u32, @bitCast(@as(c_int, 1))),
            @as(u32, @bitCast(@as(c_int, 909194329))) => return version >= @as(u32, @bitCast(@as(c_int, 1))),
            @as(u32, @bitCast(@as(c_int, 808670808))) => return version >= @as(u32, @bitCast(@as(c_int, 1))),
            @as(u32, @bitCast(@as(c_int, 909334104))) => return version >= @as(u32, @bitCast(@as(c_int, 1))),
            @as(u32, @bitCast(@as(c_int, 942954072))) => return version >= @as(u32, @bitCast(@as(c_int, 1))),
            @as(u32, @bitCast(@as(c_int, 810299481))) => return version >= @as(u32, @bitCast(@as(c_int, 1))),
            @as(u32, @bitCast(@as(c_int, 810299480))) => return version >= @as(u32, @bitCast(@as(c_int, 1))),
            @as(u32, @bitCast(@as(c_int, 843853913))) => return version >= @as(u32, @bitCast(@as(c_int, 1))),
            @as(u32, @bitCast(@as(c_int, 843853912))) => return version >= @as(u32, @bitCast(@as(c_int, 1))),
            @as(u32, @bitCast(@as(c_int, 942691673))) => return version >= @as(u32, @bitCast(@as(c_int, 1))),
            @as(u32, @bitCast(@as(c_int, 808539481))) => return version >= @as(u32, @bitCast(@as(c_int, 1))),
            @as(u32, @bitCast(@as(c_int, 943805016))) => return version >= @as(u32, @bitCast(@as(c_int, 1))),
            @as(u32, @bitCast(@as(c_int, 943800920))) => return version >= @as(u32, @bitCast(@as(c_int, 1))),
            @as(u32, @bitCast(@as(c_int, 943806546))) => return version >= @as(u32, @bitCast(@as(c_int, 1))),
            @as(u32, @bitCast(@as(c_int, 943806530))) => return version >= @as(u32, @bitCast(@as(c_int, 1))),
            @as(u32, @bitCast(@as(c_int, 943798354))) => return version >= @as(u32, @bitCast(@as(c_int, 1))),
            @as(u32, @bitCast(@as(c_int, 943798338))) => return version >= @as(u32, @bitCast(@as(c_int, 1))),
            @as(u32, @bitCast(@as(c_int, 943797586))) => return version >= @as(u32, @bitCast(@as(c_int, 1))),
            @as(u32, @bitCast(@as(c_int, 943797570))) => return version >= @as(u32, @bitCast(@as(c_int, 1))),
            @as(u32, @bitCast(@as(c_int, 875714126))) => return version >= @as(u32, @bitCast(@as(c_int, 1))),
            @as(u32, @bitCast(@as(c_int, 842290766))) => return version >= @as(u32, @bitCast(@as(c_int, 1))),
            @as(u32, @bitCast(@as(c_int, 808530512))) => return version >= @as(u32, @bitCast(@as(c_int, 1))),
            @as(u32, @bitCast(@as(c_int, 808530000))) => return version >= @as(u32, @bitCast(@as(c_int, 1))),
            @as(u32, @bitCast(@as(c_int, 842084432))) => return version >= @as(u32, @bitCast(@as(c_int, 1))),
            @as(u32, @bitCast(@as(c_int, 909193296))) => return version >= @as(u32, @bitCast(@as(c_int, 1))),
            @as(u32, @bitCast(@as(c_int, 808534593))) => return version >= @as(u32, @bitCast(@as(c_int, 1))),
            @as(u32, @bitCast(@as(c_int, 892425806))) => return version >= @as(u32, @bitCast(@as(c_int, 1))),
            @as(u32, @bitCast(@as(c_int, 808531025))) => return version >= @as(u32, @bitCast(@as(c_int, 1))),
            @as(u32, @bitCast(@as(c_int, 825242705))) => return version >= @as(u32, @bitCast(@as(c_int, 1))),
            @as(u32, @bitCast(@as(c_int, 942953048))) => return version >= @as(u32, @bitCast(@as(c_int, 1))),
            @as(u32, @bitCast(@as(c_int, 942948952))) => return version >= @as(u32, @bitCast(@as(c_int, 1))),
            @as(u32, @bitCast(@as(c_int, 942953025))) => return version >= @as(u32, @bitCast(@as(c_int, 1))),
            @as(u32, @bitCast(@as(c_int, 942948929))) => return version >= @as(u32, @bitCast(@as(c_int, 1))),
            @as(u32, @bitCast(@as(c_int, 538980675))) => return version >= @as(u32, @bitCast(@as(c_int, 1))),
            @as(u32, @bitCast(@as(c_int, 538980931))) => return version >= @as(u32, @bitCast(@as(c_int, 1))),
            @as(u32, @bitCast(@as(c_int, 538981443))) => return version >= @as(u32, @bitCast(@as(c_int, 1))),
            @as(u32, @bitCast(@as(c_int, 538980676))) => return version >= @as(u32, @bitCast(@as(c_int, 1))),
            @as(u32, @bitCast(@as(c_int, 538980932))) => return version >= @as(u32, @bitCast(@as(c_int, 1))),
            @as(u32, @bitCast(@as(c_int, 538981444))) => return version >= @as(u32, @bitCast(@as(c_int, 1))),
            @as(u32, @bitCast(@as(c_int, 538982468))) => return version >= @as(u32, @bitCast(@as(c_int, 1))),
            @as(u32, @bitCast(@as(c_int, 538980690))) => return version >= @as(u32, @bitCast(@as(c_int, 1))),
            @as(u32, @bitCast(@as(c_int, 538980946))) => return version >= @as(u32, @bitCast(@as(c_int, 1))),
            @as(u32, @bitCast(@as(c_int, 538981458))) => return version >= @as(u32, @bitCast(@as(c_int, 1))),
            @as(u32, @bitCast(@as(c_int, 540029266))) => return version >= @as(u32, @bitCast(@as(c_int, 1))),
            @as(u32, @bitCast(@as(c_int, 540160338))) => return version >= @as(u32, @bitCast(@as(c_int, 1))),
            @as(u32, @bitCast(@as(c_int, 1498764865))) => return version >= @as(u32, @bitCast(@as(c_int, 1))),
            @as(u32, @bitCast(@as(c_int, 1498764888))) => return version >= @as(u32, @bitCast(@as(c_int, 1))),
            @as(u32, @bitCast(@as(c_int, 808661072))) => return version >= @as(u32, @bitCast(@as(c_int, 1))),
            else => return @as(c_int, 0) != 0,
        }
        break;
    }
...
pub const struct_wl_shm_interface = extern struct {
    create_pool: ?*const fn (?*struct_wl_client, [*c]struct_wl_resource, u32, i32, i32) callconv(.C) void = @import("std").mem.zeroes(?*const fn (?*struct_wl_client, [*c]struct_wl_resource, u32, i32, i32) callconv(.C) void),
    release: ?*const fn (?*struct_wl_client, [*c]struct_wl_resource) callconv(.C) void = @import("std").mem.zeroes(?*const fn (?*struct_wl_client, [*c]struct_wl_resource) callconv(.C) void),
};
pub fn wl_shm_send_format(arg_resource_: [*c]struct_wl_resource, arg_format: u32) callconv(.C) void {
    var resource_ = arg_resource_;
    _ = &resource_;
    var format = arg_format;
    _ = &format;
    wl_resource_post_event(resource_, @as(u32, @bitCast(@as(c_int, 0))), format);
}
pub const struct_wl_buffer_interface = extern struct {
    destroy: ?*const fn (?*struct_wl_client, [*c]struct_wl_resource) callconv(.C) void = @import("std").mem.zeroes(?*const fn (?*struct_wl_client, [*c]struct_wl_resource) callconv(.C) void),
};
pub fn wl_buffer_send_release(arg_resource_: [*c]struct_wl_resource) callconv(.C) void {
    var resource_ = arg_resource_;
    _ = &resource_;
    wl_resource_post_event(resource_, @as(u32, @bitCast(@as(c_int, 0))));
}
...
pub fn wl_data_offer_error_is_valid(arg_value: u32, arg_version: u32) callconv(.C) bool {
    var value = arg_value;
    _ = &value;
    var version = arg_version;
    _ = &version;
...
pub const struct_wl_data_offer_interface = extern struct {
    accept: ?*const fn (?*struct_wl_client, [*c]struct_wl_resource, u32, [*c]const u8) callconv(.C) void = @import("std").mem.zeroes(?*const fn (?*struct_wl_client, [*c]struct_wl_resource, u32, [*c]const u8) callconv(.C) void),
    receive: ?*const fn (?*struct_wl_client, [*c]struct_wl_resource, [*c]const u8, i32) callconv(.C) void = @import("std").mem.zeroes(?*const fn (?*struct_wl_client, [*c]struct_wl_resource, [*c]const u8, i32) callconv(.C) void),
    destroy: ?*const fn (?*struct_wl_client, [*c]struct_wl_resource) callconv(.C) void = @import("std").mem.zeroes(?*const fn (?*struct_wl_client, [*c]struct_wl_resource) callconv(.C) void),
    finish: ?*const fn (?*struct_wl_client, [*c]struct_wl_resource) callconv(.C) void = @import("std").mem.zeroes(?*const fn (?*struct_wl_client, [*c]struct_wl_resource) callconv(.C) void),
    set_actions: ?*const fn (?*struct_wl_client, [*c]struct_wl_resource, u32, u32) callconv(.C) void = @import("std").mem.zeroes(?*const fn (?*struct_wl_client, [*c]struct_wl_resource, u32, u32) callconv(.C) void),
};
pub fn wl_data_offer_send_offer(arg_resource_: [*c]struct_wl_resource, arg_mime_type: [*c]const u8) callconv(.C) void {
    var resource_ = arg_resource_;
    _ = &resource_;
    var mime_type = arg_mime_type;
    _ = &mime_type;
    wl_resource_post_event(resource_, @as(u32, @bitCast(@as(c_int, 0))), mime_type);
}
pub fn wl_data_offer_send_source_actions(arg_resource_: [*c]struct_wl_resource, arg_source_actions: u32) callconv(.C) void {
    var resource_ = arg_resource_;
    _ = &resource_;
    var source_actions = arg_source_actions;
    _ = &source_actions;
    wl_resource_post_event(resource_, @as(u32, @bitCast(@as(c_int, 1))), source_actions);
}
pub fn wl_data_offer_send_action(arg_resource_: [*c]struct_wl_resource, arg_dnd_action: u32) callconv(.C) void {
    var resource_ = arg_resource_;
    _ = &resource_;
    var dnd_action = arg_dnd_action;
    _ = &dnd_action;
    wl_resource_post_event(resource_, @as(u32, @bitCast(@as(c_int, 2))), dnd_action);
}
...
pub fn wl_data_source_error_is_valid(arg_value: u32, arg_version: u32) callconv(.C) bool {
    var value = arg_value;
    _ = &value;
    var version = arg_version;
    _ = &version;
...
pub const struct_wl_data_source_interface = extern struct {
    offer: ?*const fn (?*struct_wl_client, [*c]struct_wl_resource, [*c]const u8) callconv(.C) void = @import("std").mem.zeroes(?*const fn (?*struct_wl_client, [*c]struct_wl_resource, [*c]const u8) callconv(.C) void),
    destroy: ?*const fn (?*struct_wl_client, [*c]struct_wl_resource) callconv(.C) void = @import("std").mem.zeroes(?*const fn (?*struct_wl_client, [*c]struct_wl_resource) callconv(.C) void),
    set_actions: ?*const fn (?*struct_wl_client, [*c]struct_wl_resource, u32) callconv(.C) void = @import("std").mem.zeroes(?*const fn (?*struct_wl_client, [*c]struct_wl_resource, u32) callconv(.C) void),
};
pub fn wl_data_source_send_target(arg_resource_: [*c]struct_wl_resource, arg_mime_type: [*c]const u8) callconv(.C) void {
    var resource_ = arg_resource_;
    _ = &resource_;
    var mime_type = arg_mime_type;
    _ = &mime_type;
...
pub fn wl_data_source_send_send(arg_resource_: [*c]struct_wl_resource, arg_mime_type: [*c]const u8, arg_fd: i32) callconv(.C) void {
    var resource_ = arg_resource_;
    _ = &resource_;
    var mime_type = arg_mime_type;
    _ = &mime_type;
    var fd = arg_fd;
    _ = &fd;
    wl_resource_post_event(resource_, @as(u32, @bitCast(@as(c_int, 1))), mime_type, fd);
}
pub fn wl_data_source_send_cancelled(arg_resource_: [*c]struct_wl_resource) callconv(.C) void {
    var resource_ = arg_resource_;
    _ = &resource_;
    wl_resource_post_event(resource_, @as(u32, @bitCast(@as(c_int, 2))));
}
pub fn wl_data_source_send_dnd_drop_performed(arg_resource_: [*c]struct_wl_resource) callconv(.C) void {
    var resource_ = arg_resource_;
    _ = &resource_;
    wl_resource_post_event(resource_, @as(u32, @bitCast(@as(c_int, 3))));
}
pub fn wl_data_source_send_dnd_finished(arg_resource_: [*c]struct_wl_resource) callconv(.C) void {
    var resource_ = arg_resource_;
    _ = &resource_;
    wl_resource_post_event(resource_, @as(u32, @bitCast(@as(c_int, 4))));
}
pub fn wl_data_source_send_action(arg_resource_: [*c]struct_wl_resource, arg_dnd_action: u32) callconv(.C) void {
    var resource_ = arg_resource_;
    _ = &resource_;
    var dnd_action = arg_dnd_action;
    _ = &dnd_action;
    wl_resource_post_event(resource_, @as(u32, @bitCast(@as(c_int, 5))), dnd_action);
}
...
pub fn wl_data_device_error_is_valid(arg_value: u32, arg_version: u32) callconv(.C) bool {
    var value = arg_value;
    _ = &value;
    var version = arg_version;
    _ = &version;
...
pub const struct_wl_data_device_interface = extern struct {
    start_drag: ?*const fn (?*struct_wl_client, [*c]struct_wl_resource, [*c]struct_wl_resource, [*c]struct_wl_resource, [*c]struct_wl_resource, u32) callconv(.C) void = @import("std").mem.zeroes(?*const fn (?*struct_wl_client, [*c]struct_wl_resource, [*c]struct_wl_resource, [*c]struct_wl_resource, [*c]struct_wl_resource, u32) callconv(.C) void),
    set_selection: ?*const fn (?*struct_wl_client, [*c]struct_wl_resource, [*c]struct_wl_resource, u32) callconv(.C) void = @import("std").mem.zeroes(?*const fn (?*struct_wl_client, [*c]struct_wl_resource, [*c]struct_wl_resource, u32) callconv(.C) void),
    release: ?*const fn (?*struct_wl_client, [*c]struct_wl_resource) callconv(.C) void = @import("std").mem.zeroes(?*const fn (?*struct_wl_client, [*c]struct_wl_resource) callconv(.C) void),
};
pub fn wl_data_device_send_data_offer(arg_resource_: [*c]struct_wl_resource, arg_id: [*c]struct_wl_resource) callconv(.C) void {
    var resource_ = arg_resource_;
    _ = &resource_;
    var id = arg_id;
    _ = &id;
    wl_resource_post_event(resource_, @as(u32, @bitCast(@as(c_int, 0))), id);
}
pub fn wl_data_device_send_enter(arg_resource_: [*c]struct_wl_resource, arg_serial: u32, arg_surface: [*c]struct_wl_resource, arg_x: wl_fixed_t, arg_y: wl_fixed_t, arg_id: [*c]struct_wl_resource) callconv(.C) void {
    var resource_ = arg_resource_;
    _ = &resource_;
    ...
    var id = arg_id;
    _ = &id;
    wl_resource_post_event(resource_, @as(u32, @bitCast(@as(c_int, 1))), serial, surface, x, y, id);
}
pub fn wl_data_device_send_leave(arg_resource_: [*c]struct_wl_resource) callconv(.C) void {
    var resource_ = arg_resource_;
    _ = &resource_;
    wl_resource_post_event(resource_, @as(u32, @bitCast(@as(c_int, 2))));
}
pub fn wl_data_device_send_motion(arg_resource_: [*c]struct_wl_resource, arg_time: u32, arg_x: wl_fixed_t, arg_y: wl_fixed_t) callconv(.C) void {
    var resource_ = arg_resource_;
    _ = &resource_;
    var time = arg_time;
    _ = &time;
    ...
    var y = arg_y;
    _ = &y;
    wl_resource_post_event(resource_, @as(u32, @bitCast(@as(c_int, 3))), time, x, y);
}
pub fn wl_data_device_send_drop(arg_resource_: [*c]struct_wl_resource) callconv(.C) void {
    var resource_ = arg_resource_;
    _ = &resource_;
    wl_resource_post_event(resource_, @as(u32, @bitCast(@as(c_int, 4))));
}
pub fn wl_data_device_send_selection(arg_resource_: [*c]struct_wl_resource, arg_id: [*c]struct_wl_resource) callconv(.C) void {
    var resource_ = arg_resource_;
    _ = &resource_;
    var id = arg_id;
    _ = &id;
    wl_resource_post_event(resource_, @as(u32, @bitCast(@as(c_int, 5))), id);
}
...
pub fn wl_data_device_manager_dnd_action_is_valid(arg_value: u32, arg_version: u32) callconv(.C) bool {
    var value = arg_value;
    _ = &value;
    var version = arg_version;
    _ = &version;
    var valid: u32 = 0;
    _ = &valid;
    if (version >= @as(u32, @bitCast(@as(c_int, 1)))) {
        valid |= @as(u32, @bitCast(WL_DATA_DEVICE_MANAGER_DND_ACTION_NONE));
    }
    if (version >= @as(u32, @bitCast(@as(c_int, 1)))) {
        valid |= @as(u32, @bitCast(WL_DATA_DEVICE_MANAGER_DND_ACTION_COPY));
    }
    if (version >= @as(u32, @bitCast(@as(c_int, 1)))) {
        valid |= @as(u32, @bitCast(WL_DATA_DEVICE_MANAGER_DND_ACTION_MOVE));
    }
    if (version >= @as(u32, @bitCast(@as(c_int, 1)))) {
        valid |= @as(u32, @bitCast(WL_DATA_DEVICE_MANAGER_DND_ACTION_ASK));
    }
    return (value & ~valid) == @as(u32, @bitCast(@as(c_int, 0)));
}
pub const struct_wl_data_device_manager_interface = extern struct {
    create_data_source: ?*const fn (?*struct_wl_client, [*c]struct_wl_resource, u32) callconv(.C) void = @import("std").mem.zeroes(?*const fn (?*struct_wl_client, [*c]struct_wl_resource, u32) callconv(.C) void),
    get_data_device: ?*const fn (?*struct_wl_client, [*c]struct_wl_resource, u32, [*c]struct_wl_resource) callconv(.C) void = @import("std").mem.zeroes(?*const fn (?*struct_wl_client, [*c]struct_wl_resource, u32, [*c]struct_wl_resource) callconv(.C) void),
};
pub const WL_SHELL_ERROR_ROLE: c_int = 0;
pub const enum_wl_shell_error = c_uint;
pub fn wl_shell_error_is_valid(arg_value: u32, arg_version: u32) callconv(.C) bool {
    var value = arg_value;
    _ = &value;
    var version = arg_version;
    _ = &version;
...
pub const struct_wl_shell_interface = extern struct {
    get_shell_surface: ?*const fn (?*struct_wl_client, [*c]struct_wl_resource, u32, [*c]struct_wl_resource) callconv(.C) void = @import("std").mem.zeroes(?*const fn (?*struct_wl_client, [*c]struct_wl_resource, u32, [*c]struct_wl_resource) callconv(.C) void),
};
...
pub fn wl_shell_surface_resize_is_valid(arg_value: u32, arg_version: u32) callconv(.C) bool {
    var value = arg_value;
    _ = &value;
    var version = arg_version;
    _ = &version;
    ...
    _ = &valid;
    if (version >= @as(u32, @bitCast(@as(c_int, 1)))) {
        valid |= @as(u32, @bitCast(WL_SHELL_SURFACE_RESIZE_NONE));
    }
    if (version >= @as(u32, @bitCast(@as(c_int, 1)))) {
        valid |= @as(u32, @bitCast(WL_SHELL_SURFACE_RESIZE_TOP));
    }
    if (version >= @as(u32, @bitCast(@as(c_int, 1)))) {
        valid |= @as(u32, @bitCast(WL_SHELL_SURFACE_RESIZE_BOTTOM));
    }
    if (version >= @as(u32, @bitCast(@as(c_int, 1)))) {
        valid |= @as(u32, @bitCast(WL_SHELL_SURFACE_RESIZE_LEFT));
    }
    if (version >= @as(u32, @bitCast(@as(c_int, 1)))) {
        valid |= @as(u32, @bitCast(WL_SHELL_SURFACE_RESIZE_TOP_LEFT));
    }
    if (version >= @as(u32, @bitCast(@as(c_int, 1)))) {
        valid |= @as(u32, @bitCast(WL_SHELL_SURFACE_RESIZE_BOTTOM_LEFT));
    }
    if (version >= @as(u32, @bitCast(@as(c_int, 1)))) {
        valid |= @as(u32, @bitCast(WL_SHELL_SURFACE_RESIZE_RIGHT));
    }
    if (version >= @as(u32, @bitCast(@as(c_int, 1)))) {
        valid |= @as(u32, @bitCast(WL_SHELL_SURFACE_RESIZE_TOP_RIGHT));
    }
    if (version >= @as(u32, @bitCast(@as(c_int, 1)))) {
        valid |= @as(u32, @bitCast(WL_SHELL_SURFACE_RESIZE_BOTTOM_RIGHT));
    }
    return (value & ~valid) == @as(u32, @bitCast(@as(c_int, 0)));
}
pub const WL_SHELL_SURFACE_TRANSIENT_INACTIVE: c_int = 1;
pub const enum_wl_shell_surface_transient = c_uint;
pub fn wl_shell_surface_transient_is_valid(arg_value: u32, arg_version: u32) callconv(.C) bool {
    var value = arg_value;
    _ = &value;
    var version = arg_version;
    _ = &version;
    ...
    _ = &valid;
    if (version >= @as(u32, @bitCast(@as(c_int, 1)))) {
        valid |= @as(u32, @bitCast(WL_SHELL_SURFACE_TRANSIENT_INACTIVE));
    }
    return (value & ~valid) == @as(u32, @bitCast(@as(c_int, 0)));
}
...
pub fn wl_shell_surface_fullscreen_method_is_valid(arg_value: u32, arg_version: u32) callconv(.C) bool {
    var value = arg_value;
    _ = &value;
    var version = arg_version;
    _ = &version;
...
pub const struct_wl_shell_surface_interface = extern struct {
    pong: ?*const fn (?*struct_wl_client, [*c]struct_wl_resource, u32) callconv(.C) void = @import("std").mem.zeroes(?*const fn (?*struct_wl_client, [*c]struct_wl_resource, u32) callconv(.C) void),
    move: ?*const fn (?*struct_wl_client, [*c]struct_wl_resource, [*c]struct_wl_resource, u32) callconv(.C) void = @import("std").mem.zeroes(?*const fn (?*struct_wl_client, [*c]struct_wl_resource, [*c]struct_wl_resource, u32) callconv(.C) void),
    resize: ?*const fn (?*struct_wl_client, [*c]struct_wl_resource, [*c]struct_wl_resource, u32, u32) callconv(.C) void = @import("std").mem.zeroes(?*const fn (?*struct_wl_client, [*c]struct_wl_resource, [*c]struct_wl_resource, u32, u32) callconv(.C) void),
    set_toplevel: ?*const fn (?*struct_wl_client, [*c]struct_wl_resource) callconv(.C) void = @import("std").mem.zeroes(?*const fn (?*struct_wl_client, [*c]struct_wl_resource) callconv(.C) void),
    set_transient: ?*const fn (?*struct_wl_client, [*c]struct_wl_resource, [*c]struct_wl_resource, i32, i32, u32) callconv(.C) void = @import("std").mem.zeroes(?*const fn (?*struct_wl_client, [*c]struct_wl_resource, [*c]struct_wl_resource, i32, i32, u32) callconv(.C) void),
    set_fullscreen: ?*const fn (?*struct_wl_client, [*c]struct_wl_resource, u32, u32, [*c]struct_wl_resource) callconv(.C) void = @import("std").mem.zeroes(?*const fn (?*struct_wl_client, [*c]struct_wl_resource, u32, u32, [*c]struct_wl_resource) callconv(.C) void),
    set_popup: ?*const fn (?*struct_wl_client, [*c]struct_wl_resource, [*c]struct_wl_resource, u32, [*c]struct_wl_resource, i32, i32, u32) callconv(.C) void = @import("std").mem.zeroes(?*const fn (?*struct_wl_client, [*c]struct_wl_resource, [*c]struct_wl_resource, u32, [*c]struct_wl_resource, i32, i32, u32) callconv(.C) void),
    set_maximized: ?*const fn (?*struct_wl_client, [*c]struct_wl_resource, [*c]struct_wl_resource) callconv(.C) void = @import("std").mem.zeroes(?*const fn (?*struct_wl_client, [*c]struct_wl_resource, [*c]struct_wl_resource) callconv(.C) void),
    set_title: ?*const fn (?*struct_wl_client, [*c]struct_wl_resource, [*c]const u8) callconv(.C) void = @import("std").mem.zeroes(?*const fn (?*struct_wl_client, [*c]struct_wl_resource, [*c]const u8) callconv(.C) void),
    set_class: ?*const fn (?*struct_wl_client, [*c]struct_wl_resource, [*c]const u8) callconv(.C) void = @import("std").mem.zeroes(?*const fn (?*struct_wl_client, [*c]struct_wl_resource, [*c]const u8) callconv(.C) void),
};
pub fn wl_shell_surface_send_ping(arg_resource_: [*c]struct_wl_resource, arg_serial: u32) callconv(.C) void {
    var resource_ = arg_resource_;
    _ = &resource_;
    var serial = arg_serial;
    _ = &serial;
    wl_resource_post_event(resource_, @as(u32, @bitCast(@as(c_int, 0))), serial);
}
pub fn wl_shell_surface_send_configure(arg_resource_: [*c]struct_wl_resource, arg_edges: u32, arg_width: i32, arg_height: i32) callconv(.C) void {
    var resource_ = arg_resource_;
    _ = &resource_;
    var edges = arg_edges;
    _ = &edges;
    ...
    _ = &height;
    wl_resource_post_event(resource_, @as(u32, @bitCast(@as(c_int, 1))), edges, width, height);
}
pub fn wl_shell_surface_send_popup_done(arg_resource_: [*c]struct_wl_resource) callconv(.C) void {
    var resource_ = arg_resource_;
    _ = &resource_;
    wl_resource_post_event(resource_, @as(u32, @bitCast(@as(c_int, 2))));
}
...
pub fn wl_surface_error_is_valid(arg_value: u32, arg_version: u32) callconv(.C) bool {
    var value = arg_value;
    _ = &value;
    var version = arg_version;
    _ = &version;
    while (true) {
        switch (value) {
            ...
            @as(u32, @bitCast(@as(c_int, 2))) => return version >= @as(u32, @bitCast(@as(c_int, 1))),
            @as(u32, @bitCast(@as(c_int, 3))) => return version >= @as(u32, @bitCast(@as(c_int, 1))),
            @as(u32, @bitCast(@as(c_int, 4))) => return version >= @as(u32, @bitCast(@as(c_int, 1))),
            else => return @as(c_int, 0) != 0,
        }
        break;
    }
...
pub const struct_wl_surface_interface = extern struct {
    destroy: ?*const fn (?*struct_wl_client, [*c]struct_wl_resource) callconv(.C) void = @import("std").mem.zeroes(?*const fn (?*struct_wl_client, [*c]struct_wl_resource) callconv(.C) void),
    attach: ?*const fn (?*struct_wl_client, [*c]struct_wl_resource, [*c]struct_wl_resource, i32, i32) callconv(.C) void = @import("std").mem.zeroes(?*const fn (?*struct_wl_client, [*c]struct_wl_resource, [*c]struct_wl_resource, i32, i32) callconv(.C) void),
    damage: ?*const fn (?*struct_wl_client, [*c]struct_wl_resource, i32, i32, i32, i32) callconv(.C) void = @import("std").mem.zeroes(?*const fn (?*struct_wl_client, [*c]struct_wl_resource, i32, i32, i32, i32) callconv(.C) void),
    frame: ?*const fn (?*struct_wl_client, [*c]struct_wl_resource, u32) callconv(.C) void = @import("std").mem.zeroes(?*const fn (?*struct_wl_client, [*c]struct_wl_resource, u32) callconv(.C) void),
    set_opaque_region: ?*const fn (?*struct_wl_client, [*c]struct_wl_resource, [*c]struct_wl_resource) callconv(.C) void = @import("std").mem.zeroes(?*const fn (?*struct_wl_client, [*c]struct_wl_resource, [*c]struct_wl_resource) callconv(.C) void),
    set_input_region: ?*const fn (?*struct_wl_client, [*c]struct_wl_resource, [*c]struct_wl_resource) callconv(.C) void = @import("std").mem.zeroes(?*const fn (?*struct_wl_client, [*c]struct_wl_resource, [*c]struct_wl_resource) callconv(.C) void),
    commit: ?*const fn (?*struct_wl_client, [*c]struct_wl_resource) callconv(.C) void = @import("std").mem.zeroes(?*const fn (?*struct_wl_client, [*c]struct_wl_resource) callconv(.C) void),
    set_buffer_transform: ?*const fn (?*struct_wl_client, [*c]struct_wl_resource, i32) callconv(.C) void = @import("std").mem.zeroes(?*const fn (?*struct_wl_client, [*c]struct_wl_resource, i32) callconv(.C) void),
    set_buffer_scale: ?*const fn (?*struct_wl_client, [*c]struct_wl_resource, i32) callconv(.C) void = @import("std").mem.zeroes(?*const fn (?*struct_wl_client, [*c]struct_wl_resource, i32) callconv(.C) void),
    damage_buffer: ?*const fn (?*struct_wl_client, [*c]struct_wl_resource, i32, i32, i32, i32) callconv(.C) void = @import("std").mem.zeroes(?*const fn (?*struct_wl_client, [*c]struct_wl_resource, i32, i32, i32, i32) callconv(.C) void),
    offset: ?*const fn (?*struct_wl_client, [*c]struct_wl_resource, i32, i32) callconv(.C) void = @import("std").mem.zeroes(?*const fn (?*struct_wl_client, [*c]struct_wl_resource, i32, i32) callconv(.C) void),
};
pub fn wl_surface_send_enter(arg_resource_: [*c]struct_wl_resource, arg_output: [*c]struct_wl_resource) callconv(.C) void {
    var resource_ = arg_resource_;
    _ = &resource_;
    var output = arg_output;
    _ = &output;
    wl_resource_post_event(resource_, @as(u32, @bitCast(@as(c_int, 0))), output);
}
pub fn wl_surface_send_leave(arg_resource_: [*c]struct_wl_resource, arg_output: [*c]struct_wl_resource) callconv(.C) void {
    var resource_ = arg_resource_;
    _ = &resource_;
    var output = arg_output;
    _ = &output;
    wl_resource_post_event(resource_, @as(u32, @bitCast(@as(c_int, 1))), output);
}
pub fn wl_surface_send_preferred_buffer_scale(arg_resource_: [*c]struct_wl_resource, arg_factor: i32) callconv(.C) void {
    var resource_ = arg_resource_;
    _ = &resource_;
    var factor = arg_factor;
    _ = &factor;
    wl_resource_post_event(resource_, @as(u32, @bitCast(@as(c_int, 2))), factor);
}
pub fn wl_surface_send_preferred_buffer_transform(arg_resource_: [*c]struct_wl_resource, arg_transform: u32) callconv(.C) void {
    var resource_ = arg_resource_;
    _ = &resource_;
    var transform = arg_transform;
    _ = &transform;
    wl_resource_post_event(resource_, @as(u32, @bitCast(@as(c_int, 3))), transform);
}
...
pub fn wl_seat_capability_is_valid(arg_value: u32, arg_version: u32) callconv(.C) bool {
    var value = arg_value;
    _ = &value;
    var version = arg_version;
    _ = &version;
    ...
    _ = &valid;
    if (version >= @as(u32, @bitCast(@as(c_int, 1)))) {
        valid |= @as(u32, @bitCast(WL_SEAT_CAPABILITY_POINTER));
    }
    if (version >= @as(u32, @bitCast(@as(c_int, 1)))) {
        valid |= @as(u32, @bitCast(WL_SEAT_CAPABILITY_KEYBOARD));
    }
    if (version >= @as(u32, @bitCast(@as(c_int, 1)))) {
        valid |= @as(u32, @bitCast(WL_SEAT_CAPABILITY_TOUCH));
    }
    return (value & ~valid) == @as(u32, @bitCast(@as(c_int, 0)));
}
pub const WL_SEAT_ERROR_MISSING_CAPABILITY: c_int = 0;
pub const enum_wl_seat_error = c_uint;
pub fn wl_seat_error_is_valid(arg_value: u32, arg_version: u32) callconv(.C) bool {
    var value = arg_value;
    _ = &value;
    var version = arg_version;
    _ = &version;
...
pub const struct_wl_seat_interface = extern struct {
    get_pointer: ?*const fn (?*struct_wl_client, [*c]struct_wl_resource, u32) callconv(.C) void = @import("std").mem.zeroes(?*const fn (?*struct_wl_client, [*c]struct_wl_resource, u32) callconv(.C) void),
    get_keyboard: ?*const fn (?*struct_wl_client, [*c]struct_wl_resource, u32) callconv(.C) void = @import("std").mem.zeroes(?*const fn (?*struct_wl_client, [*c]struct_wl_resource, u32) callconv(.C) void),
    get_touch: ?*const fn (?*struct_wl_client, [*c]struct_wl_resource, u32) callconv(.C) void = @import("std").mem.zeroes(?*const fn (?*struct_wl_client, [*c]struct_wl_resource, u32) callconv(.C) void),
    release: ?*const fn (?*struct_wl_client, [*c]struct_wl_resource) callconv(.C) void = @import("std").mem.zeroes(?*const fn (?*struct_wl_client, [*c]struct_wl_resource) callconv(.C) void),
};
pub fn wl_seat_send_capabilities(arg_resource_: [*c]struct_wl_resource, arg_capabilities: u32) callconv(.C) void {
    var resource_ = arg_resource_;
    _ = &resource_;
    var capabilities = arg_capabilities;
    _ = &capabilities;
    wl_resource_post_event(resource_, @as(u32, @bitCast(@as(c_int, 0))), capabilities);
}
pub fn wl_seat_send_name(arg_resource_: [*c]struct_wl_resource, arg_name: [*c]const u8) callconv(.C) void {
    var resource_ = arg_resource_;
    _ = &resource_;
    var name = arg_name;
    _ = &name;
...
pub fn wl_pointer_error_is_valid(arg_value: u32, arg_version: u32) callconv(.C) bool {
    var value = arg_value;
    _ = &value;
    var version = arg_version;
    _ = &version;
...
pub fn wl_pointer_button_state_is_valid(arg_value: u32, arg_version: u32) callconv(.C) bool {
    var value = arg_value;
    _ = &value;
    var version = arg_version;
    _ = &version;
...
pub fn wl_pointer_axis_is_valid(arg_value: u32, arg_version: u32) callconv(.C) bool {
    var value = arg_value;
    _ = &value;
    var version = arg_version;
    _ = &version;
...
pub fn wl_pointer_axis_source_is_valid(arg_value: u32, arg_version: u32) callconv(.C) bool {
    var value = arg_value;
    _ = &value;
    var version = arg_version;
    _ = &version;
    while (true) {
        switch (value) {
            ...
            @as(u32, @bitCast(@as(c_int, 1))) => return version >= @as(u32, @bitCast(@as(c_int, 1))),
            @as(u32, @bitCast(@as(c_int, 2))) => return version >= @as(u32, @bitCast(@as(c_int, 1))),
            @as(u32, @bitCast(@as(c_int, 3))) => return version >= @as(u32, @bitCast(@as(c_int, 6))),
            else => return @as(c_int, 0) != 0,
        }
        break;
    }
...
pub fn wl_pointer_axis_relative_direction_is_valid(arg_value: u32, arg_version: u32) callconv(.C) bool {
    var value = arg_value;
    _ = &value;
    var version = arg_version;
    _ = &version;
...
pub const struct_wl_pointer_interface = extern struct {
    set_cursor: ?*const fn (?*struct_wl_client, [*c]struct_wl_resource, u32, [*c]struct_wl_resource, i32, i32) callconv(.C) void = @import("std").mem.zeroes(?*const fn (?*struct_wl_client, [*c]struct_wl_resource, u32, [*c]struct_wl_resource, i32, i32) callconv(.C) void),
    release: ?*const fn (?*struct_wl_client, [*c]struct_wl_resource) callconv(.C) void = @import("std").mem.zeroes(?*const fn (?*struct_wl_client, [*c]struct_wl_resource) callconv(.C) void),
};
pub fn wl_pointer_send_enter(arg_resource_: [*c]struct_wl_resource, arg_serial: u32, arg_surface: [*c]struct_wl_resource, arg_surface_x: wl_fixed_t, arg_surface_y: wl_fixed_t) callconv(.C) void {
    var resource_ = arg_resource_;
    _ = &resource_;
    var serial = arg_serial;
    _ = &serial;
    ...
    _ = &surface_y;
    wl_resource_post_event(resource_, @as(u32, @bitCast(@as(c_int, 0))), serial, surface, surface_x, surface_y);
}
pub fn wl_pointer_send_leave(arg_resource_: [*c]struct_wl_resource, arg_serial: u32, arg_surface: [*c]struct_wl_resource) callconv(.C) void {
    var resource_ = arg_resource_;
    _ = &resource_;
    var serial = arg_serial;
    _ = &serial;
    var surface = arg_surface;
    _ = &surface;
    wl_resource_post_event(resource_, @as(u32, @bitCast(@as(c_int, 1))), serial, surface);
}
pub fn wl_pointer_send_motion(arg_resource_: [*c]struct_wl_resource, arg_time: u32, arg_surface_x: wl_fixed_t, arg_surface_y: wl_fixed_t) callconv(.C) void {
    var resource_ = arg_resource_;
    _ = &resource_;
    var time = arg_time;
    _ = &time;
    ...
    var surface_y = arg_surface_y;
    _ = &surface_y;
    wl_resource_post_event(resource_, @as(u32, @bitCast(@as(c_int, 2))), time, surface_x, surface_y);
}
pub fn wl_pointer_send_button(arg_resource_: [*c]struct_wl_resource, arg_serial: u32, arg_time: u32, arg_button: u32, arg_state: u32) callconv(.C) void {
    var resource_ = arg_resource_;
    _ = &resource_;
    var serial = arg_serial;
    _ = &serial;
    ...
    var state = arg_state;
    _ = &state;
    wl_resource_post_event(resource_, @as(u32, @bitCast(@as(c_int, 3))), serial, time, button, state);
}
pub fn wl_pointer_send_axis(arg_resource_: [*c]struct_wl_resource, arg_time: u32, arg_axis: u32, arg_value: wl_fixed_t) callconv(.C) void {
    var resource_ = arg_resource_;
    _ = &resource_;
    var time = arg_time;
    _ = &time;
    ...
    var value = arg_value;
    _ = &value;
    wl_resource_post_event(resource_, @as(u32, @bitCast(@as(c_int, 4))), time, axis, value);
}
pub fn wl_pointer_send_frame(arg_resource_: [*c]struct_wl_resource) callconv(.C) void {
    var resource_ = arg_resource_;
    _ = &resource_;
    wl_resource_post_event(resource_, @as(u32, @bitCast(@as(c_int, 5))));
}
pub fn wl_pointer_send_axis_source(arg_resource_: [*c]struct_wl_resource, arg_axis_source: u32) callconv(.C) void {
    var resource_ = arg_resource_;
    _ = &resource_;
    var axis_source = arg_axis_source;
    _ = &axis_source;
    wl_resource_post_event(resource_, @as(u32, @bitCast(@as(c_int, 6))), axis_source);
}
pub fn wl_pointer_send_axis_stop(arg_resource_: [*c]struct_wl_resource, arg_time: u32, arg_axis: u32) callconv(.C) void {
    var resource_ = arg_resource_;
    _ = &resource_;
    var time = arg_time;
    _ = &time;
    var axis = arg_axis;
    _ = &axis;
    wl_resource_post_event(resource_, @as(u32, @bitCast(@as(c_int, 7))), time, axis);
}
pub fn wl_pointer_send_axis_discrete(arg_resource_: [*c]struct_wl_resource, arg_axis: u32, arg_discrete: i32) callconv(.C) void {
    var resource_ = arg_resource_;
    _ = &resource_;
    var axis = arg_axis;
    _ = &axis;
    ...
    _ = &discrete;
    wl_resource_post_event(resource_, @as(u32, @bitCast(@as(c_int, 8))), axis, discrete);
}
pub fn wl_pointer_send_axis_value120(arg_resource_: [*c]struct_wl_resource, arg_axis: u32, arg_value120: i32) callconv(.C) void {
    var resource_ = arg_resource_;
    _ = &resource_;
    var axis = arg_axis;
    _ = &axis;
    var value120 = arg_value120;
    _ = &value120;
    wl_resource_post_event(resource_, @as(u32, @bitCast(@as(c_int, 9))), axis, value120);
}
pub fn wl_pointer_send_axis_relative_direction(arg_resource_: [*c]struct_wl_resource, arg_axis: u32, arg_direction: u32) callconv(.C) void {
    var resource_ = arg_resource_;
    _ = &resource_;
    var axis = arg_axis;
    _ = &axis;
    ...
    _ = &direction;
    wl_resource_post_event(resource_, @as(u32, @bitCast(@as(c_int, 10))), axis, direction);
}
...
pub fn wl_keyboard_keymap_format_is_valid(arg_value: u32, arg_version: u32) callconv(.C) bool {
    var value = arg_value;
    _ = &value;
    var version = arg_version;
    _ = &version;
...
pub fn wl_keyboard_key_state_is_valid(arg_value: u32, arg_version: u32) callconv(.C) bool {
    var value = arg_value;
    _ = &value;
    var version = arg_version;
    _ = &version;
...
pub fn wl_keyboard_send_keymap(arg_resource_: [*c]struct_wl_resource, arg_format: u32, arg_fd: i32, arg_size: u32) callconv(.C) void {
    var resource_ = arg_resource_;
    _ = &resource_;
    var format = arg_format;
    _ = &format;
    ...
    var size = arg_size;
    _ = &size;
    wl_resource_post_event(resource_, @as(u32, @bitCast(@as(c_int, 0))), format, fd, size);
}
pub fn wl_keyboard_send_enter(arg_resource_: [*c]struct_wl_resource, arg_serial: u32, arg_surface: [*c]struct_wl_resource, arg_keys: [*c]struct_wl_array) callconv(.C) void {
    var resource_ = arg_resource_;
    _ = &resource_;
    var serial = arg_serial;
    _ = &serial;
    ...
    var keys = arg_keys;
    _ = &keys;
    wl_resource_post_event(resource_, @as(u32, @bitCast(@as(c_int, 1))), serial, surface, keys);
}
pub fn wl_keyboard_send_leave(arg_resource_: [*c]struct_wl_resource, arg_serial: u32, arg_surface: [*c]struct_wl_resource) callconv(.C) void {
    var resource_ = arg_resource_;
    _ = &resource_;
    var serial = arg_serial;
    _ = &serial;
    var surface = arg_surface;
    _ = &surface;
    wl_resource_post_event(resource_, @as(u32, @bitCast(@as(c_int, 2))), serial, surface);
}
pub fn wl_keyboard_send_key(arg_resource_: [*c]struct_wl_resource, arg_serial: u32, arg_time: u32, arg_key: u32, arg_state: u32) callconv(.C) void {
    var resource_ = arg_resource_;
    _ = &resource_;
    var serial = arg_serial;
    _ = &serial;
    ...
    var state = arg_state;
    _ = &state;
    wl_resource_post_event(resource_, @as(u32, @bitCast(@as(c_int, 3))), serial, time, key, state);
}
pub fn wl_keyboard_send_modifiers(arg_resource_: [*c]struct_wl_resource, arg_serial: u32, arg_mods_depressed: u32, arg_mods_latched: u32, arg_mods_locked: u32, arg_group: u32) callconv(.C) void {
    var resource_ = arg_resource_;
    _ = &resource_;
    var serial = arg_serial;
    _ = &serial;
    ...
    var group = arg_group;
    _ = &group;
    wl_resource_post_event(resource_, @as(u32, @bitCast(@as(c_int, 4))), serial, mods_depressed, mods_latched, mods_locked, group);
}
pub fn wl_keyboard_send_repeat_info(arg_resource_: [*c]struct_wl_resource, arg_rate: i32, arg_delay: i32) callconv(.C) void {
    var resource_ = arg_resource_;
    _ = &resource_;
    var rate = arg_rate;
    _ = &rate;
    var delay = arg_delay;
    _ = &delay;
    wl_resource_post_event(resource_, @as(u32, @bitCast(@as(c_int, 5))), rate, delay);
}
pub const struct_wl_touch_interface = extern struct {
    release: ?*const fn (?*struct_wl_client, [*c]struct_wl_resource) callconv(.C) void = @import("std").mem.zeroes(?*const fn (?*struct_wl_client, [*c]struct_wl_resource) callconv(.C) void),
};
pub fn wl_touch_send_down(arg_resource_: [*c]struct_wl_resource, arg_serial: u32, arg_time: u32, arg_surface: [*c]struct_wl_resource, arg_id: i32, arg_x: wl_fixed_t, arg_y: wl_fixed_t) callconv(.C) void {
    var resource_ = arg_resource_;
    _ = &resource_;
    var serial = arg_serial;
    _ = &serial;
    ...
    var y = arg_y;
    _ = &y;
    wl_resource_post_event(resource_, @as(u32, @bitCast(@as(c_int, 0))), serial, time, surface, id, x, y);
}
pub fn wl_touch_send_up(arg_resource_: [*c]struct_wl_resource, arg_serial: u32, arg_time: u32, arg_id: i32) callconv(.C) void {
    var resource_ = arg_resource_;
    _ = &resource_;
    var serial = arg_serial;
    _ = &serial;
    ...
    var id = arg_id;
    _ = &id;
    wl_resource_post_event(resource_, @as(u32, @bitCast(@as(c_int, 1))), serial, time, id);
}
pub fn wl_touch_send_motion(arg_resource_: [*c]struct_wl_resource, arg_time: u32, arg_id: i32, arg_x: wl_fixed_t, arg_y: wl_fixed_t) callconv(.C) void {
    var resource_ = arg_resource_;
    _ = &resource_;
    var time = arg_time;
    _ = &time;
    ...
    var y = arg_y;
    _ = &y;
    wl_resource_post_event(resource_, @as(u32, @bitCast(@as(c_int, 2))), time, id, x, y);
}
pub fn wl_touch_send_frame(arg_resource_: [*c]struct_wl_resource) callconv(.C) void {
    var resource_ = arg_resource_;
    _ = &resource_;
    wl_resource_post_event(resource_, @as(u32, @bitCast(@as(c_int, 3))));
}
pub fn wl_touch_send_cancel(arg_resource_: [*c]struct_wl_resource) callconv(.C) void {
    var resource_ = arg_resource_;
    _ = &resource_;
    wl_resource_post_event(resource_, @as(u32, @bitCast(@as(c_int, 4))));
}
pub fn wl_touch_send_shape(arg_resource_: [*c]struct_wl_resource, arg_id: i32, arg_major: wl_fixed_t, arg_minor: wl_fixed_t) callconv(.C) void {
    var resource_ = arg_resource_;
    _ = &resource_;
    var id = arg_id;
    _ = &id;
    ...
    var minor = arg_minor;
    _ = &minor;
    wl_resource_post_event(resource_, @as(u32, @bitCast(@as(c_int, 5))), id, major, minor);
}
pub fn wl_touch_send_orientation(arg_resource_: [*c]struct_wl_resource, arg_id: i32, arg_orientation: wl_fixed_t) callconv(.C) void {
    var resource_ = arg_resource_;
    _ = &resource_;
    var id = arg_id;
    _ = &id;
    ...
    _ = &orientation;
    wl_resource_post_event(resource_, @as(u32, @bitCast(@as(c_int, 6))), id, orientation);
}
...
pub fn wl_output_subpixel_is_valid(arg_value: u32, arg_version: u32) callconv(.C) bool {
    var value = arg_value;
    _ = &value;
    var version = arg_version;
    _ = &version;
    while (true) {
        switch (value) {
            ...
            @as(u32, @bitCast(@as(c_int, 3))) => return version >= @as(u32, @bitCast(@as(c_int, 1))),
            @as(u32, @bitCast(@as(c_int, 4))) => return version >= @as(u32, @bitCast(@as(c_int, 1))),
            @as(u32, @bitCast(@as(c_int, 5))) => return version >= @as(u32, @bitCast(@as(c_int, 1))),
            else => return @as(c_int, 0) != 0,
        }
        break;
    }
...
pub fn wl_output_transform_is_valid(arg_value: u32, arg_version: u32) callconv(.C) bool {
    var value = arg_value;
    _ = &value;
    var version = arg_version;
    _ = &version;
    while (true) {
        switch (value) {
            ...
            @as(u32, @bitCast(@as(c_int, 4))) => return version >= @as(u32, @bitCast(@as(c_int, 1))),
            @as(u32, @bitCast(@as(c_int, 5))) => return version >= @as(u32, @bitCast(@as(c_int, 1))),
            @as(u32, @bitCast(@as(c_int, 6))) => return version >= @as(u32, @bitCast(@as(c_int, 1))),
            @as(u32, @bitCast(@as(c_int, 7))) => return version >= @as(u32, @bitCast(@as(c_int, 1))),
            else => return @as(c_int, 0) != 0,
        }
        break;
    }
...
pub fn wl_output_mode_is_valid(arg_value: u32, arg_version: u32) callconv(.C) bool {
    var value = arg_value;
    _ = &value;
    var version = arg_version;
    _ = &version;
    ...
    _ = &valid;
    if (version >= @as(u32, @bitCast(@as(c_int, 1)))) {
        valid |= @as(u32, @bitCast(WL_OUTPUT_MODE_CURRENT));
    }
    if (version >= @as(u32, @bitCast(@as(c_int, 1)))) {
        valid |= @as(u32, @bitCast(WL_OUTPUT_MODE_PREFERRED));
    }
    return (value & ~valid) == @as(u32, @bitCast(@as(c_int, 0)));
}
...
pub fn wl_output_send_geometry(arg_resource_: [*c]struct_wl_resource, arg_x: i32, arg_y: i32, arg_physical_width: i32, arg_physical_height: i32, arg_subpixel: i32, arg_make: [*c]const u8, arg_model: [*c]const u8, arg_transform: i32) callconv(.C) void {
    var resource_ = arg_resource_;
    _ = &resource_;
    var x = arg_x;
    _ = &x;
    ...
    var transform = arg_transform;
    _ = &transform;
    wl_resource_post_event(resource_, @as(u32, @bitCast(@as(c_int, 0))), x, y, physical_width, physical_height, subpixel, make, model, transform);
}
pub fn wl_output_send_mode(arg_resource_: [*c]struct_wl_resource, arg_flags: u32, arg_width: i32, arg_height: i32, arg_refresh: i32) callconv(.C) void {
    var resource_ = arg_resource_;
    _ = &resource_;
    var flags = arg_flags;
    _ = &flags;
    ...
    _ = &refresh;
    wl_resource_post_event(resource_, @as(u32, @bitCast(@as(c_int, 1))), flags, width, height, refresh);
}
pub fn wl_output_send_done(arg_resource_: [*c]struct_wl_resource) callconv(.C) void {
    var resource_ = arg_resource_;
    _ = &resource_;
    wl_resource_post_event(resource_, @as(u32, @bitCast(@as(c_int, 2))));
}
pub fn wl_output_send_scale(arg_resource_: [*c]struct_wl_resource, arg_factor: i32) callconv(.C) void {
    var resource_ = arg_resource_;
    _ = &resource_;
    var factor = arg_factor;
    _ = &factor;
    wl_resource_post_event(resource_, @as(u32, @bitCast(@as(c_int, 3))), factor);
}
pub fn wl_output_send_name(arg_resource_: [*c]struct_wl_resource, arg_name: [*c]const u8) callconv(.C) void {
    var resource_ = arg_resource_;
    _ = &resource_;
    var name = arg_name;
    _ = &name;
    wl_resource_post_event(resource_, @as(u32, @bitCast(@as(c_int, 4))), name);
}
pub fn wl_output_send_description(arg_resource_: [*c]struct_wl_resource, arg_description: [*c]const u8) callconv(.C) void {
    var resource_ = arg_resource_;
    _ = &resource_;
    var description = arg_description;
    _ = &description;
    wl_resource_post_event(resource_, @as(u32, @bitCast(@as(c_int, 5))), description);
}
pub const struct_wl_region_interface = extern struct {
    destroy: ?*const fn (?*struct_wl_client, [*c]struct_wl_resource) callconv(.C) void = @import("std").mem.zeroes(?*const fn (?*struct_wl_client, [*c]struct_wl_resource) callconv(.C) void),
    add: ?*const fn (?*struct_wl_client, [*c]struct_wl_resource, i32, i32, i32, i32) callconv(.C) void = @import("std").mem.zeroes(?*const fn (?*struct_wl_client, [*c]struct_wl_resource, i32, i32, i32, i32) callconv(.C) void),
    subtract: ?*const fn (?*struct_wl_client, [*c]struct_wl_resource, i32, i32, i32, i32) callconv(.C) void = @import("std").mem.zeroes(?*const fn (?*struct_wl_client, [*c]struct_wl_resource, i32, i32, i32, i32) callconv(.C) void),
};
...
pub fn wl_subcompositor_error_is_valid(arg_value: u32, arg_version: u32) callconv(.C) bool {
    var value = arg_value;
    _ = &value;
    var version = arg_version;
    _ = &version;
...
pub const struct_wl_subcompositor_interface = extern struct {
    destroy: ?*const fn (?*struct_wl_client, [*c]struct_wl_resource) callconv(.C) void = @import("std").mem.zeroes(?*const fn (?*struct_wl_client, [*c]struct_wl_resource) callconv(.C) void),
    get_subsurface: ?*const fn (?*struct_wl_client, [*c]struct_wl_resource, u32, [*c]struct_wl_resource, [*c]struct_wl_resource) callconv(.C) void = @import("std").mem.zeroes(?*const fn (?*struct_wl_client, [*c]struct_wl_resource, u32, [*c]struct_wl_resource, [*c]struct_wl_resource) callconv(.C) void),
};
pub const WL_SUBSURFACE_ERROR_BAD_SURFACE: c_int = 0;
pub const enum_wl_subsurface_error = c_uint;
pub fn wl_subsurface_error_is_valid(arg_value: u32, arg_version: u32) callconv(.C) bool {
    var value = arg_value;
    _ = &value;
    var version = arg_version;
    _ = &version;
...
pub const struct_wl_subsurface_interface = extern struct {
    destroy: ?*const fn (?*struct_wl_client, [*c]struct_wl_resource) callconv(.C) void = @import("std").mem.zeroes(?*const fn (?*struct_wl_client, [*c]struct_wl_resource) callconv(.C) void),
    set_position: ?*const fn (?*struct_wl_client, [*c]struct_wl_resource, i32, i32) callconv(.C) void = @import("std").mem.zeroes(?*const fn (?*struct_wl_client, [*c]struct_wl_resource, i32, i32) callconv(.C) void),
    place_above: ?*const fn (?*struct_wl_client, [*c]struct_wl_resource, [*c]struct_wl_resource) callconv(.C) void = @import("std").mem.zeroes(?*const fn (?*struct_wl_client, [*c]struct_wl_resource, [*c]struct_wl_resource) callconv(.C) void),
    place_below: ?*const fn (?*struct_wl_client, [*c]struct_wl_resource, [*c]struct_wl_resource) callconv(.C) void = @import("std").mem.zeroes(?*const fn (?*struct_wl_client, [*c]struct_wl_resource, [*c]struct_wl_resource) callconv(.C) void),
    set_sync: ?*const fn (?*struct_wl_client, [*c]struct_wl_resource) callconv(.C) void = @import("std").mem.zeroes(?*const fn (?*struct_wl_client, [*c]struct_wl_resource) callconv(.C) void),
    set_desync: ?*const fn (?*struct_wl_client, [*c]struct_wl_resource) callconv(.C) void = @import("std").mem.zeroes(?*const fn (?*struct_wl_client, [*c]struct_wl_resource) callconv(.C) void),
};
...
pub const WAYLAND_SERVER_CORE_H = "";
...
pub const wl_client_for_each = @compileError("unable to translate C expr: unexpected token 'for'");
// /usr/include/wayland-server-core.h:315:9
pub const wl_resource_for_each = @compileError("unable to translate C expr: unexpected token 'for'");
// /usr/include/wayland-server-core.h:628:9
pub const wl_resource_for_each_safe = @compileError("unable to translate C expr: unexpected token 'for'");
// /usr/include/wayland-server-core.h:633:9
pub const WAYLAND_SERVER_PROTOCOL_H = "";
...
pub const WL_DISPLAY_ERROR = @as(c_int, 0);
pub const WL_DISPLAY_DELETE_ID = @as(c_int, 1);
...
pub const WL_REGISTRY_GLOBAL = @as(c_int, 0);
pub const WL_REGISTRY_GLOBAL_REMOVE = @as(c_int, 1);
...
pub const WL_CALLBACK_DONE = @as(c_int, 0);
...
pub const WL_SHM_FORMAT = @as(c_int, 0);
...
pub const WL_BUFFER_RELEASE = @as(c_int, 0);
...
pub const WL_DATA_OFFER_OFFER = @as(c_int, 0);
pub const WL_DATA_OFFER_SOURCE_ACTIONS = @as(c_int, 1);
pub const WL_DATA_OFFER_ACTION = @as(c_int, 2);
...
pub const WL_DATA_SOURCE_TARGET = @as(c_int, 0);
pub const WL_DATA_SOURCE_SEND = @as(c_int, 1);
pub const WL_DATA_SOURCE_CANCELLED = @as(c_int, 2);
pub const WL_DATA_SOURCE_DND_DROP_PERFORMED = @as(c_int, 3);
pub const WL_DATA_SOURCE_DND_FINISHED = @as(c_int, 4);
pub const WL_DATA_SOURCE_ACTION = @as(c_int, 5);
...
pub const WL_DATA_DEVICE_DATA_OFFER = @as(c_int, 0);
pub const WL_DATA_DEVICE_ENTER = @as(c_int, 1);
pub const WL_DATA_DEVICE_LEAVE = @as(c_int, 2);
pub const WL_DATA_DEVICE_MOTION = @as(c_int, 3);
pub const WL_DATA_DEVICE_DROP = @as(c_int, 4);
pub const WL_DATA_DEVICE_SELECTION = @as(c_int, 5);
...
pub const WL_SHELL_SURFACE_PING = @as(c_int, 0);
pub const WL_SHELL_SURFACE_CONFIGURE = @as(c_int, 1);
pub const WL_SHELL_SURFACE_POPUP_DONE = @as(c_int, 2);
...
pub const WL_SURFACE_ENTER = @as(c_int, 0);
pub const WL_SURFACE_LEAVE = @as(c_int, 1);
pub const WL_SURFACE_PREFERRED_BUFFER_SCALE = @as(c_int, 2);
pub const WL_SURFACE_PREFERRED_BUFFER_TRANSFORM = @as(c_int, 3);
...
pub const WL_SEAT_CAPABILITIES = @as(c_int, 0);
pub const WL_SEAT_NAME = @as(c_int, 1);
...
pub const WL_POINTER_ENTER = @as(c_int, 0);
pub const WL_POINTER_LEAVE = @as(c_int, 1);
pub const WL_POINTER_MOTION = @as(c_int, 2);
pub const WL_POINTER_BUTTON = @as(c_int, 3);
pub const WL_POINTER_AXIS = @as(c_int, 4);
pub const WL_POINTER_FRAME = @as(c_int, 5);
pub const WL_POINTER_AXIS_SOURCE = @as(c_int, 6);
pub const WL_POINTER_AXIS_STOP = @as(c_int, 7);
pub const WL_POINTER_AXIS_DISCRETE = @as(c_int, 8);
pub const WL_POINTER_AXIS_VALUE120 = @as(c_int, 9);
pub const WL_POINTER_AXIS_RELATIVE_DIRECTION = @as(c_int, 10);
...
pub const WL_KEYBOARD_KEYMAP = @as(c_int, 0);
pub const WL_KEYBOARD_ENTER = @as(c_int, 1);
pub const WL_KEYBOARD_LEAVE = @as(c_int, 2);
pub const WL_KEYBOARD_KEY = @as(c_int, 3);
pub const WL_KEYBOARD_MODIFIERS = @as(c_int, 4);
pub const WL_KEYBOARD_REPEAT_INFO = @as(c_int, 5);
...
pub const WL_TOUCH_DOWN = @as(c_int, 0);
pub const WL_TOUCH_UP = @as(c_int, 1);
pub const WL_TOUCH_MOTION = @as(c_int, 2);
pub const WL_TOUCH_FRAME = @as(c_int, 3);
pub const WL_TOUCH_CANCEL = @as(c_int, 4);
pub const WL_TOUCH_SHAPE = @as(c_int, 5);
pub const WL_TOUCH_ORIENTATION = @as(c_int, 6);
...
pub const WL_OUTPUT_GEOMETRY = @as(c_int, 0);
pub const WL_OUTPUT_MODE = @as(c_int, 1);
pub const WL_OUTPUT_DONE = @as(c_int, 2);
pub const WL_OUTPUT_SCALE = @as(c_int, 3);
pub const WL_OUTPUT_NAME = @as(c_int, 4);
pub const WL_OUTPUT_DESCRIPTION = @as(c_int, 5);
...
pub const wl_event_loop = struct_wl_event_loop;
pub const wl_event_source = struct_wl_event_source;
pub const wl_listener = struct_wl_listener;
pub const wl_display = struct_wl_display;
pub const wl_client = struct_wl_client;
pub const wl_global = struct_wl_global;
pub const wl_signal = struct_wl_signal;
pub const wl_resource = struct_wl_resource;
pub const wl_shm_buffer = struct_wl_shm_buffer;
pub const wl_shm_pool = struct_wl_shm_pool;
pub const wl_protocol_logger_type = enum_wl_protocol_logger_type;
pub const wl_protocol_logger_message = struct_wl_protocol_logger_message;
pub const wl_protocol_logger = struct_wl_protocol_logger;
